...
use crate::client::apis::lol_chat::get_conversations::{LolChatConversation, LolChatConversationResource};
use crate::client::apis::lol_chat::get_friends::{LolChatFriendResource, LolChatFriendsResource};
...
pub struct ChatState {
    ...
    pub conversations: LolChatConversationResource,
    pub friends: combo_box::State<LolChatFriendResource>,
    pub selected_conversation: Option<LolChatConversation>,
...
pub enum ChatMessage {
    ConversationsResult(AppResult<LolChatConversationResource>),
    FriendsResult(AppResult<LolChatFriendsResource>),
    ConversationSelected(LolChatConversation),
        ...
        if let AppState::Connected(connected_state) = state {
            match message {
                ChatMessage::ConversationsResult(result) => {
                    connected_state.chat.conversations = result.unwrap_or_default();
