...
use crate::client::apis::lol_game_queues::get_custom_queues::{LolGameQueuesQueueCustomGameSubcategory, LolGameQueuesQueueGameTypeConfig};
use crate::client::apis::lol_game_queues::get_queues::LolGameMode;
use crate::client::apis::lol_lobby::post_lobby::{LolLobbyQueueCustomGameSpectatorPolicy, LolLobbyQueueGameTypeConfig};
                    ...
                    if let Some(queue) = &connected_state.play.create_lobby_state.custom_state.selected_queue{
                        if let Some(mutator) = &connected_state.play.create_lobby_state.custom_state.selected_mutator {
                            return crate::client::utils::perform_request(
                                connected_state,
                                crate::client::apis::lol_lobby::post_lobby(
                                    crate::client::apis::lol_lobby::post_lobby::LolLobbyPostLobbyBody {
                                        queue_id: 0,
                                        is_custom: true,
                                        custom_game_lobby: Some(crate::client::apis::lol_lobby::post_lobby::LolLobbyLobbyCustomGameLobby {
                                            lobby_name: connected_state.play.create_lobby_state.custom_state.name.clone(),
                                            lobby_password: if connected_state.play.create_lobby_state.custom_state.password.is_empty() { None } else { Some(connected_state.play.create_lobby_state.custom_state.password.clone()) },
                                            configuration: crate::client::apis::lol_lobby::post_lobby::LolLobbyLobbyCustomGameConfiguration {
                                                map_id: queue.map_id,
                                                game_mode: queue.game_mode.clone(),
                                                mutators: LolLobbyQueueGameTypeConfig { id: mutator.id },
