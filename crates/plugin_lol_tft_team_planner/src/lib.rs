...
pub fn delete_lol_tft_team_planner_v_1_team_champions_by_id_by_champion_name(champion_name: String) -> DeleteLolTftTeamPlannerV1TeamChampionsByIdByChampionName {
    DeleteLolTftTeamPlannerV1TeamChampionsByIdByChampionName {
        champion_name
    }
}
...
pub fn delete_lol_tft_team_planner_v_1_team_dirty() -> DeleteLolTftTeamPlannerV1TeamDirty {
...
impl IsApiRequest for GetLolTftTeamPlannerV1Config {
    ...
    fn get_url(&self) -> String {
        "/lol-tft-team-planner/v1/config".to_string()
    }
...
pub fn get_lol_tft_team_planner_v_1_config() -> GetLolTftTeamPlannerV1Config {
...
pub fn get_lol_tft_team_planner_v_1_ftue_has_viewed() -> GetLolTftTeamPlannerV1FtueHasViewed {
...
impl IsApiRequest for GetLolTftTeamPlannerV1TeamLocal {
    ...
    fn get_url(&self) -> String {
        "/lol-tft-team-planner/v1/team/local".to_string()
    }
...
pub fn get_lol_tft_team_planner_v_1_team_local() -> GetLolTftTeamPlannerV1TeamLocal {
...
pub fn get_lol_tft_team_planner_v_1_team_reminders() -> GetLolTftTeamPlannerV1TeamReminders {
...
impl IsApiRequest for PatchLolTftTeamPlannerV1Set {
    ...
    fn get_url(&self) -> String {
        "/lol-tft-team-planner/v1/set".to_string()
    }
...
impl IsApiRequest for PutLolTftTeamPlannerV1Team {
    ...
    fn get_url(&self) -> String {
        "/lol-tft-team-planner/v1/team".to_string()
    }
...
pub fn put_lol_tft_team_planner_v_1_team() -> PutLolTftTeamPlannerV1Team {
