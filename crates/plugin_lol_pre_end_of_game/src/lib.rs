...
pub fn delete_lol_pre_end_of_game_v1_registration_by_sequence_event_name(sequence_event_name: String) -> DeleteLolPreEndOfGameV1RegistrationBySequenceEventName {
...
pub fn get_lol_pre_end_of_game_v1_current_sequence_event() -> GetLolPreEndOfGameV1CurrentSequenceEvent {
...
pub fn post_lol_pre_end_of_game_v1_complete_by_sequence_event_name(sequence_event_name: String) -> PostLolPreEndOfGameV1CompleteBySequenceEventName {
...
pub fn post_lol_pre_end_of_game_v1_registration_by_sequence_event_name_by_priority(sequence_event_name: String, priority: i32) -> PostLolPreEndOfGameV1RegistrationBySequenceEventNameByPriority {
