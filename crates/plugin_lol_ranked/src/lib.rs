...
pub struct LolRankedRankedQueueStats {
    ...
    pub warnings: LolRankedRankedQueueWarnings,
}
...
pub struct LolRankedRankedQueueStatsDto {
    ...
    pub warnings: LolRankedRankedQueueWarningsDto,
}
...
pub struct LolRankedRewardsInfo {
    ...
    pub current_split: LolRankedSeasonSplit,
...
pub struct LolRankedRankedStats {
    ...
    pub highest_ranked_entry: LolRankedRankedQueueStats,
    pub highest_ranked_entry_sr: LolRankedRankedQueueStats,
    pub earned_regalia_reward_ids: Vec<String>,
    pub ranked_regalia_level: i32,
...
pub struct LolRankedLeagueLadderInfo {
    ...
    pub requested_ranked_entry: LolRankedLeagueStanding,
}
...
pub struct LolRankedLcuLeagueNotification {
    ...
    pub split_points_notification: LolRankedSplitPointsNotification,
