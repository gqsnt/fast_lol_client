...
pub struct LolPurchaseWidgetCatalogPluginItem {
    ...
    pub quest_skin_info: LolPurchaseWidgetSkinLineInfo,
    pub active: bool,
    pub ownership_type: LolPurchaseWidgetInventoryOwnership,
}
...
pub struct LolPurchaseWidgetCatalogPluginPrice {
    ...
    pub sale: LolPurchaseWidgetCatalogPluginSale,
}
...
pub struct LolPurchaseWidgetItemDefinition {
    ...
    pub tags: Vec<String>,
    pub metadata: Vec<LolPurchaseWidgetItemMetadataEntry>,
    pub bundled_item_price: LolPurchaseWidgetBundledItemPricingInfo,
...
pub struct LolPurchaseWidgetPurchasableItem {
    ...
    pub sale: LolPurchaseWidgetItemSale,
...
pub struct LolPurchaseWidgetPriceOptionDto {
    pub price: i64,
    pub currency_type: String,
    pub currency_payment_option: String,
    pub currency_name: String,
    pub currency_image_path: String,
}
...
pub struct LolPurchaseWidgetPurchaseOfferResponseV3 {
    pub legacy: bool,
    pub order_dto: LolPurchaseWidgetCapOrdersOrderDto,
}
